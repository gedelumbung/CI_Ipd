...
<div id="kulit-luar">
<div id="menu-atas">
<div class="logo"><a href="index.php"><img src="<?php echo base_url();?>system/application/views/ipd/image/logo.png" border="0" /></a></div>
</div>
...
<table>
<tr><td rowspan="3"><img src="<?php echo base_url();?>system/application/views/ipd/image/login-icon.png"/></td><td width="80">Nim</td><td width="10">:</td><td width="200"><input name="username" type="text" size="30" class="texfield"/></td>
